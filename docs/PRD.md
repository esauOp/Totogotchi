...
| 9 | **DECIDED 2026-09-07** Five-mood pixel-art sloth bundled in the app (§5.1, §9.2) | Resolved | Supplied by the owner, generated with an AI image tool. Fine for personal use; the tool's terms need checking before any distribution. Provenance recorded in `Art/README.md` | Owner | Closed |
